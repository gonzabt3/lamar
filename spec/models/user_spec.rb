...
RSpec.describe User, type: :model do
  describe "#create" do
    context "with valid params" do
      it "creates a resource" do
        expect{
          User.create(email: "test-user@gmail.com", name: "test-name", surname: "test-surname", nickname: "test-nickname", password: "test-password")
  ...
  describe "::favorite_name" do
    describe "when user has nickname" do
      let(:user) { create(:user, name: "test-name", surname: "test-surname", nickname: "test-nickname", password: "test-password") }
      it "returns nickname" do
        expect(user.favorite_name).to eq(user.nickname)
      end
    end
    describe "when user not has nickname" do
      let(:user) { create(:user, name: "test-name", surname: "test-surname", nickname: nil, password: "test-password") }
